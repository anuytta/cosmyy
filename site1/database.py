...
def checkout():
    if request.method == 'POST':
        ...
        return redirect(url_for('order_placed'))  # Перенаправлення на сторінку підтвердження
...
@app.route('/catalog')
def show_catalog():
    categories = get_categories()  # Отримуємо всі категорії
    print(categories)  # Перевірка, чи є категорії
